...
export default function ContentInfo({MernData}) {
  return (
  <>
    <div className=' xl:flex xl:flex-col mx-1 mt-4 xl:items-center'>  
      ...
      {MernData.map((CurElm)=>{
        return (
            <div className='mb-3 xl:w-[50vw]'>
                ...
                <div>
                    <p className='font-workSans mx-2 xl:text-base p-1 w-[95vw] xl:w-fit '>{CurElm.description}</p>
          ...
          <div className='xl:w-[50vw]'>
            <h2 className='mx-3 font-archivo text-xl text-zinc-800 xl:text-2xl'>Why MERN stack?</h2>
              <p className='font-workSans mx-2 my-2 xl:text-base p-1 w-[95vw] xl:w-fit '>
